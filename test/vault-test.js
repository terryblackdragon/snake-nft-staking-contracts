...
describe("NFTStakingVault.sol", () => {
    ...
    beforeEach(async () => {
        ...
        // Deploy APE ERC20 token contract 
    ...
    describe("Correct Deployement", () => {
        ...
        it("NFT contract should have correct initial parameters", async () => {
            ...
            await expect(nftContract.tokenURI(1)).to.be.revertedWithCustomError(nftContract, 'APE__QueryForNonExistentToken');
        });
    ...
    describe("Core Functions", () => {
        ...
        it("should not allow user to mint NFT while contract is paused", async () => {
            ...
            await expect(
                ...
                nftContract, "APE__ContractIsPaused"
            )
        });
        ...
        it("should not allow random users to mint KPT tokens", async () => {
            ...
            ).to.be.revertedWithCustomError(tokenContract, "SAPE__OnlyControllersCanMint")
        });
    });
