...
/// @title the APE NFT staking vault
/// @author kaymen99
/// @notice this vault allwos users to stake their APE tokens and earn daily rewards
/// based on their overall staking period, the rewards are distributed in the form of our own ERC20 token 'SAPE'
/// @dev this contract must be set as controller in the 'SAPE' contract to enable ERC20 rewards minting
